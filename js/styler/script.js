...
$(document).ready( function() {
   ...
   var setContactSectionHeight = function() {
        var routeHeight = $('.route').height();
        var contWinHeight = $(window).height() + routeHeight;

        // set all section to window height
        $('#contacts > .inner').css('min-height', contWinHeight);
   };
